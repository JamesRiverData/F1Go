...
// Revised: Polls for a specific calendar and applies blackout days, accepts optional additional dates array
...
(function(){
  ...
  /**
   * Keep trying every 500ms until the calendar for a given hidden input name is found.
   * @param {string} inputName - hidden input name
   * @param {string[]} [extraDates] - optional additional dates to blackout
   */
  ...
  window.applyBlackoutsToCalendar = waitForCalendar;

  // Example usage:
  // applyBlackoutsToCalendar('793cbb7a-a865-4b3e-a69c-2ecc2d77fd62', ['2025-10-05','2025-10-12']);
})();


export { applyBlackoutsToCalendar };